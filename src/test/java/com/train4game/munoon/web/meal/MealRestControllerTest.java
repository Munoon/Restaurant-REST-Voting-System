...
class MealRestControllerTest extends AbstractControllerTest {
    ...
    void testGetAll() throws Exception {
        List<MealTo> expected = modelMapper.map(Arrays.asList(FIRST_MEAL, SECOND_MEAL), mapperType);
    ...
    void testCreate() throws Exception {
        ...
        List<MealTo> expectedList = modelMapper.map(Arrays.asList(FIRST_MEAL, SECOND_MEAL, expected), mapperType);
